...
class fbauthorize{
    ...
    const ASSETS_PATH = 'media/plg_stilerospfacebook/assets/';
    const IMG_PATH = 'media/plg_stilerospfacebook/assets/images/';
    const JS_PATH = 'media/plg_stilerospfacebook/assets/js/';
    const CATCHER_URI = 'plugins/socialpromoter/plg_stilerospfacebook/helpers/catcherJ16.php';
    const HELPERS_URI = 'plugins/socialpromoter/plg_stilerospfacebook/helpers/';
