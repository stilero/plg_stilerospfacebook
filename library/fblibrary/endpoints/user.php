...
class StileroSPFBEndpointUser extends StileroSPFBEndpointEndpoint{
    
    protected $userId;
    
    public function __construct(\StileroSPFBOauthAccesstoken $AccessToken, $userId = 'me') {
    ...
    public function getTokenForPageWithId($id){
        ...
        $accounts = StileroSPFBOauthResponse::handle($accountList);
