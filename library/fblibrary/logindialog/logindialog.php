...
class StileroSPFBLoginDialog{
     ...
     * @param StileroSPFBOauthApp $FbApp FB app object with ID and secret
     * @param string $redirectURL The URI to redirect to after dialog
     */
    public function __construct(StileroSPFBOauthApp $FbApp, $redirectURL) {
        $this->FbApp = $FbApp;
